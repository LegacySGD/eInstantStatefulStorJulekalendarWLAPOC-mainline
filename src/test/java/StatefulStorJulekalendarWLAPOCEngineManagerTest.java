...
public class StatefulStorJulekalendarWLAPOCEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(StatefulStorJulekalendarWLAPOCEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/StatefulStorJulekalendarWLAPOCIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/StatefulStorJulekalendarWLAPOCIW/InitOutcome.xml").getDocumentElement();
